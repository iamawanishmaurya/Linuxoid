...
struct NativeApkFirstAppStartProof {
  ...
  std::string native_post_jni_dispatch_reason = "none";
  std::string native_managed_activity_dispatch_state = "not_requested";
  std::string native_managed_activity_dispatch_reason = "none";
  std::string native_managed_activity_dispatch_component;
  std::string native_managed_activity_dispatch_class_name;
  std::string native_managed_activity_dispatch_class_descriptor;
  std::string native_managed_activity_dispatch_method_name;
  std::string native_managed_activity_dispatch_method_signature;
  std::string native_managed_activity_runtime_binding_state = "not_requested";
