...
struct InstalledAppLaunchReport {
  ...
  bool runtime_core_subsystems_ready = false;
  int runtime_core_subsystem_count = 0;
  int runtime_core_ready_subsystem_count = 0;
  ...
  std::vector<std::string> runtime_core_subsystems;
  std::vector<std::string> runtime_core_subsystem_details;
