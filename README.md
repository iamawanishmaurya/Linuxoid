...
flowchart TB
  ...
  subgraph Host["Linux Host"]
    ...
    NativeArtBootstrapExec --> NativeArtBootstrapExecArtifact["art/bootstrap-execution-plan.json / result.json / trace.jsonl / context.json / runner.sh / phase logs"]
